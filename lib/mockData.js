...
// Training Module video support: each module MAY declare a video here.
// `videoUrl` is the raw admin-supplied link -- for Smart Income System
// this is the VTurb embed/player URL (see lib/moduleVideo.js
// normalizeModuleVideo(), the ONLY place these get parsed/validated/
// embedded). `videoType` is set to "vturb" for every module below since
// VTurb is the sole video host going forward; normalizeModuleVideo()
// still auto-detects Drive/YouTube/Vimeo/direct-file links by hostname
// as a fallback, so this field is mostly documentation for whoever
// edits this file next. `videoTitle` is the accessible <iframe title> /
// fallback caption.
//
// THIS FILE (MODULES_META below) is the single centralized place to add
// or change a module's VTurb URL later -- set `videoUrl` to the VTurb
// player URL for that module id and it renders automatically, no other
// code changes required. Leave `videoUrl: null` (as every module below
// currently is -- this repo ships with no real hosted video assets) to
// show the "Lesson video is being prepared." fallback instead of a
// broken player.
//
// Unlock timing is intentionally NOT stored here -- see
// MODULE_UNLOCK_HOURS below, the single centralized schedule consumed
// by lib/moduleEngine.js. Adding a module's real video URL here never
// requires touching the unlock schedule, and vice versa.
export const MODULES_META = [
  {
    id: 1,
    title: "How it Works (Nodes)",
    description:
      "An in-depth walkthrough of how Smart Income System nodes route and monetize idle bandwidth.",
    duration: "18:42",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
  ...
  {
    id: 6,
    title: "Building Consistent Earnings Habits",
    description:
      "Daily and weekly habits that keep your Bridges performing at their best over time.",
    duration: "16:20",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
  ...
  {
    id: 7,
    title: "Referral & Growth Strategies",
    description:
      "How to responsibly grow your network presence and unlock additional opportunities.",
    duration: "20:05",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
  },
  {
    ...
    description:
      "Protecting your account, credentials, and payout methods from common threats.",
    duration: "14:48",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
  },
  {
    ...
    description:
      "Diagnosing and resolving the most frequent Bridge connectivity and earnings questions.",
    duration: "18:12",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
  ...
  {
    id: 10,
    title: "Maximizing Long-Term Payouts",
    description:
      "Advanced planning for compounding your earnings across multiple payout cycles.",
    duration: "23:30",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
  ...
  {
    id: 11,
    title: "Advanced Member Certification",
    description:
      "The final training module, bringing everything together as a certified Smart Income System member.",
    duration: "25:00",
    videoUrl: null,
    videoType: "vturb",
    videoTitle: null,
