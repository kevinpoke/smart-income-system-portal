...
export const MODULES_META = [
  ...
  },
  {
    ...
    duration: "04:32",
    vturbPlayerId: "6a88fccc7e65ceed8de59dff",
    vturbScriptUrl:
      "https://scripts.converteai.net/83227717-d71e-46bb-8b52-5d76568cd774/players/6a88fccc7e65ceed8de59dff/v4/player.js",
  },
  {
    id: 6,
    ...
    duration: "09:00",
    vturbPlayerId: "6a88fcbaabfb01c4c939104a",
    vturbScriptUrl:
      "https://scripts.converteai.net/83227717-d71e-46bb-8b52-5d76568cd774/players/6a88fcbaabfb01c4c939104a/v4/player.js",
  },
  {
    id: 7,
    ...
    duration: "06:01",
    vturbPlayerId: "6a88fce794a2bd45323b1b7c",
    vturbScriptUrl:
      "https://scripts.converteai.net/83227717-d71e-46bb-8b52-5d76568cd774/players/6a88fce794a2bd45323b1b7c/v4/player.js",
  },
  {
    id: 8,
    ...
    duration: "05:20",
    vturbPlayerId: "6a88fc91224835bad227c28a",
    vturbScriptUrl:
      "https://scripts.converteai.net/83227717-d71e-46bb-8b52-5d76568cd774/players/6a88fc91224835bad227c28a/v4/player.js",
  },
  {
    id: 9,
    ...
    duration: "03:08",
    vturbPlayerId: "6a88fc7ce17f9e0fa3241598",
    vturbScriptUrl:
      "https://scripts.converteai.net/83227717-d71e-46bb-8b52-5d76568cd774/players/6a88fc7ce17f9e0fa3241598/v4/player.js",
  },
  {
    id: 10,
    ...
    duration: "05:01",
    vturbPlayerId: "6a88fca38c562ba2fe687670",
    vturbScriptUrl:
      "https://scripts.converteai.net/83227717-d71e-46bb-8b52-5d76568cd774/players/6a88fca38c562ba2fe687670/v4/player.js",
  },
];

// Payout/Withdrawal gate refinement pass: these are two DELIBERATELY
// SEPARATE module-completion gates that must never be conflated (see
// lib/moduleAccess.js for the two dedicated helper functions that each
// read exactly one of these constants):
//
//   WITHDRAWALS_MODULE_10_GATE_ID -- gates the WITHDRAWALS page/API
//   (account must have COMPLETED Module 10, "How Payouts Work"). This is
//   the ORIGINAL gate from the prior refinement pass and is UNCHANGED by
//   this batch -- see lib/moduleAccess.js hasWithdrawalsModule10Access().
//
//   PAYOUTS_TAB_MODULE_6_GATE_ID -- gates the PAYOUTS TAB/estimates page
//   (account must have COMPLETED Module 6, "Earnings Expectations" /
//   "What You Can Expect to Earn"). NEW in this batch, replacing the
//   Payouts tab's previous (incorrect) reliance on the Module 10 gate --
//   see lib/moduleAccess.js hasPayoutsTabModule6Access().
//
// Both are PAGE-ACCESS gates only; neither is the existing 4-calendar-
// month withdrawal eligibility timer (lib/earningsEngine.js
// getPayoutTargetAt), which remains completely independent and
// unchanged by either gate.
export const WITHDRAWALS_MODULE_10_GATE_ID = 10;
export const PAYOUTS_TAB_MODULE_6_GATE_ID = 6;
...
// timer math. Modules 1-3 unlock immediately (0h); modules 4-10 unlock in
// 6-hour increments after first login, per spec (cadence changed from the
// previous 16-hour increments -- ONLY the per-module hour offsets below
// changed; first_login_at remains the exact same fixed anchor it always
// was, computeModuleUnlockAtMs's formula is untouched). Module 10 is the
// FINAL module (Remove-Module-11 batch: Module 11 -- "Bonus: The AI
// Income System", previously +48h -- has been completely removed from
// the active catalog/schedule/UI/business logic; see lib/mockData.js
// MODULES_META, which no longer has an id: 11 entry, and this object,
// which no longer has an `11` key. Any pre-existing historical
// account_module_progress rows for module_key = 11 are left in place --
// see lib/moduleEngine.js's own header comment for why that is safe --
// they simply no longer correspond to any entry MODULES_META.find() can
// resolve, so they are never rendered/counted anywhere.)
...
// auto-approval at 3:30 PM). Lives here (a plain, browser-safe module
// with no node:* imports) rather than in lib/ispEngine.js directly, so
// CLIENT components (the ISP Setup page's countdown, the admin ISP
// Approvals tab's countdown) can import this exact same value without
// pulling in ispEngine.js's server-only `node:sqlite`-adjacent
// dependencies. lib/ispEngine.js re-exports this constant unchanged so
// every SERVER consumer keeps importing it from lib/ispEngine.js exactly
// as before -- there is still only one canonical value.
export const ISP_AUTO_APPROVE_AFTER_MS = 60 * 60 * 1000; // 1 hour
