...
//
// Cent ranges (post-rebrand, per spec section 5):
//   standard ("Bridge"):        $1,500-$2,500/mo -> 150000-250000 cents
//   super    ("Golden Bridge"): $2,500-$4,000/mo -> 250000-400000 cents (unchanged)
//   nova     ("XI Bridge"):     $1,000-$2,000/mo -> 100000-200000 cents
//
// IMPORTANT ranking note: prior to this rebrand, "nova" was the
// highest-earning/premium tier ($4,000-$6,000/mo). It is now the
// LOWEST-earning tier ("XI Bridge", $1,000-$2,000/mo) -- "super"
...
export const NODE_TIERS = {
  ...
  nova: {
    ...
    minCents: 100000, // $1,000 -- now the LOWEST tier, see ranking note above
    maxCents: 200000, // $2,000
    glow: "purple",
  },
};
