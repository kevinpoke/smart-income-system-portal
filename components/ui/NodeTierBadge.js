...
// pass). IX Bridge (nova) keeps its distinct purple glow treatment: a
...
// text-shadow) so IX Bridge's glow reads as "premium accent" visual
// treatment, never distracting/flashing (note: IX Bridge/nova is now
...
// definition of "what an IX Bridge looks like."

// Refinement pass (Nova/IX Bridge card glow fix): the badge above only
...
// applied to the whole table row/card container for an IX Bridge in
